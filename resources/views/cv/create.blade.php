...
@section('title', 'Build a CV — CV Craft')

@section('content')
<section class="mx-auto max-w-6xl px-6 py-16">
    <div class="mb-10 flex flex-col gap-3">
        <p class="text-sm font-semibold uppercase tracking-[0.3em] text-indigo-300/80">CV Builder</p>
        <h1 class="text-3xl font-semibold text-white">Select a template, type your story, watch it render live.</h1>
        <p class="text-white/70">Every keystroke updates the canvas on the right. Once you’re happy, export an editorial-grade PDF.</p>
    </div>
        ...
        <div class="space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-white/50">Tip: write one bullet per line with quantified impact.</p>
                </div>
                <div>
